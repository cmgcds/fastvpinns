...
$ f = -2.0 * (2 \pi x) * (sin(2 \pi x) * sin(2 \pi y))  $; $ \epsilon = 1 $ ;
...
- [Example File - sin_cos.py](#example-file---helmholtz_examplepy)
...
- [Main File - main_poisson2d.py](#main-file---main_helmholtzpy)
...
## Example File - [sin_cos.py](sin_cos.py)
---
...
- `exact_solution_generation` is set to "internal" which means that the exact solution is generated using the `exact_solution` function in the `sin_cos.py` file. For external check the other examples [cd2d_gear](../cd2d_gear/)
...
## Main File - [main_poisson2d.py](main_poisson2d.py)
---
