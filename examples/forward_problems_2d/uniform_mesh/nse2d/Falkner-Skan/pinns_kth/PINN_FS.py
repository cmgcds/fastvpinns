...
# from lbfgs import optimizer as lbfgs_op # No LGBFS
...
class PINNs(models.Model):
    def __init__(self, model, optimizer, epochs, **kwargs):
        ...
        self.hist = []
        self.epoch = 0
        # self.sopt = lbfgs_op(self.trainable_variables) # removed LGBFS
        self.nu = 0.01
    ...
    def fit(self, bc, cp):
        ...
        for epoch in tqdm(range(self.epochs)):
            ...
            # self.hist.append(
            #     hist.numpy()
            # )  # this part of cde is commented out,while running the timing experiments.
