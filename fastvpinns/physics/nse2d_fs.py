...
def pde_loss_nse2d_fs(
    ...
    pressure_x = tf.transpose(tf.linalg.matvec(test_velocity, p_grad_x_nn))
    ...
    pressure_y = tf.transpose(tf.linalg.matvec(test_velocity, p_grad_y_nn))
