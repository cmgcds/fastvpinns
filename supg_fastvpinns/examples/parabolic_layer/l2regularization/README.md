...
# Parabolic Layer Example with L2 Regularization
...
<!-- $$
a = 1, \quad b = \frac{1}{\varepsilon}, \quad L = 0, \quad R = 0
$$

$$
u(x,y) := (a \cdot x) + \left(\frac{(R - L - a) \left( e^{-b \cdot (1-x)} - e^{-b} \right)}{1 - e^{-b}} \right) + L
$$
...
- [Parabolic Layer Example with L2 Regularization](#parabolic-layer-example-with-l2-regularization)
  ...
  - [Input File](#input-file)
      ...
      - [model](#model)
      - [logging](#logging)
  - [Main File - main\_parabolic\_l2.py](#main-file---main_parabolic_l2.py)
...
```bash
python3 main_parabolic_l2.py input.yaml
```
...
```yaml
experimentation:
  output_path: "output/parabolic_l2/1"  # Path to the output directory where the results will be saved.
```
[Return to top](#contents)
...
## Main File - [main_parabolic_l2.py](main_parabolic_l2.py)
---
