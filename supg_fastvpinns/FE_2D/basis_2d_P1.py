...
# Purpose: Defines the basis functions for a 2D P1 element.
# Reference: ParMooN -  File: BF_C_T_P1_2D.h
...
class Basis2DP1(BasisFunction2D):
    """
    This class defines the basis functions for a 2D P1 element.
    """
    def __init__(self):
        super().__init__(num_shape_functions=3)
