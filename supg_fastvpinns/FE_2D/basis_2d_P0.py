...
# Purpose: Defines the basis functions for a 2D P0 element.
# Reference: ParMooN -  File: BF_C_T_P0_2D.h
...
class Basis2DP0(BasisFunction2D):
    """
    This class defines the basis functions for a 2D P0 element.
    """
    def __init__(self):
